...
class FormAndPreview extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cartoonCharacterName: "",
      cartoonCharacterPrice: "",
    };
  }
  ...
  callMintMyNFTFromApp = (e) => {
    ...
    this.props.mintMyNFT(
      ...
      this.state.cartoonCharacterName,
      this.state.cartoonCharacterPrice
    );
  };
      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color Your Cartoon Character As You Want It To be!</h5>
          </div>
        </div>
        <form onSubmit={this.callMintMyNFTFromApp} className="pt-4 mt-1">
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <CartoonCharacterNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="cartoonCharacterName">Name</label>
                <input
                  required
                  type="text"
                  value={this.state.cartoonCharacterName}
                  className="form-control"
                  placeholder="Enter Your Cartoon Character's Name"
                  onChange={(e) =>
                    this.setState({ cartoonCharacterName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  type="number"
                  name="price"
                  id="cartoonCharacterPrice"
                  value={this.state.cartoonCharacterPrice}
                  className="form-control"
                  placeholder="Enter Price In Ξ"
                  onChange={(e) =>
                    this.setState({ cartoonCharacterPrice: e.target.value })
                  }
                />
              </div>
              <button
